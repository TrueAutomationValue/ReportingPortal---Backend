package main.view.ResultResolutions;
...
public class ResultResolutionGet extends BaseServlet implements IGet, IPost, IDelete {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            List<ResultResolutionDto> resultResolutions = session.getProjectController().get(resultResolutionDto);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            session.getProjectController().create(resultResolutionDto);
        }catch (Exception e) {
            handleException(resp, e);
        }
    }
    ...
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if(project_id != null) {
                ...
                session.getProjectController().delete(resultResolutionTemplate);
            } else {
                resp.setStatus(401);
            }
        }catch (Exception e) {
