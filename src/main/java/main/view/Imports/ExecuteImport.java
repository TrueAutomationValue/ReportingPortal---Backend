...
@WebServlet("/import")
@MultipartConfig
public class ExecuteImport extends BaseServlet implements IPost {
    @Override
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if(req.getParameterMap().containsKey("importToken")){
                session = new Session();
                session.getProjectController().isTokenValid(req.getParameter("importToken"),testRunTemplate.getProject_id());
            }else{
