...
public class SuiteDashboardServlet extends BaseServlet implements IDelete, IGet, IPost {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            List<SuiteDashboardDto> dashboards = session.getProjectController().get(template);
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            template = session.getProjectController().create(template);
            setJSONContentType(resp);
    ...
    public void doDelete(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            SuiteDashboardDto template = new SuiteDashboardDto();
            template.getSearchTemplateFromRequestParameters(req);
            session.getProjectController().delete(template);
        }catch (Exception e) {
            handleException(resp, e);
        }
    }
